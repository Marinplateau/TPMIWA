...
public class Global extends GlobalSettings {
    ...
    private void addCallback() {
        ...
        String urlMainWS = service.getServiceURL(Service.MAIN_WS);
        try {
...
//                    .asString();
    ...
    private void saveService() {
        try {
            Service service = Service.getInstances();
            Unirest.post(service.getServiceURL(Service.MAIN_WS) + Service.MAIN_WS_PATH_APP)
                    .header("Content-type", "application/json")
                    .body(Json.toJson(new AppPojo(SERVICE_NAME, service.getServiceURL(SERVICE_NAME), service.getPort().toString())).toString())
                    .asString();
